...
interface RoasChartProps {
  data: Array<{ date: string; blendedRoas: number; attributedRoas: number }>
  target?: number
}
  ...
  return (
    <ResponsiveContainer width="100%" height={220}>
      <LineChart data={data} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
        ...
        <Line name="Blended ROAS" type="monotone" dataKey="blendedRoas" stroke="#6366f1" strokeWidth={2} dot={false} activeDot={{ r: 4, fill: '#6366f1' }} />
        <Line name="Attributed ROAS" type="monotone" dataKey="attributedRoas" stroke="#8b5cf6" strokeWidth={2} dot={false} strokeDasharray="4 2" activeDot={{ r: 4, fill: '#8b5cf6' }} />
      </LineChart>
    </ResponsiveContainer>
  )
}
